  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
        ...
        height: 100,
        //color: Colors.red,
        child: const Image(image: AssetImage('assets/product.png')),
      ),
    );
  }
}
    ...
    return Container(
      ...
      child: Stack(
        children:  [
          ...
          Positioned(child: _Burbujas(), top: 36, left: 2,),
          Positioned(child: _Burbujas(), top: 90, left: 56,),
          Positioned(child: _Burbujas(), bottom: 90, left: 30,),
       ]
      ),
    );
  }
